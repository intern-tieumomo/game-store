				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							...
							<li class="p-t-4">
								<a class="s-text13 active1" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
									All Genres ....
								</a>
							</li>
						</ul>
						<ul class="p-b-54 collapse" id="collapseExample">
							<li class="p-t-4">
								<a class="s-text13 active1">
									<h4 class="m-text14 p-b-7">All Genres</h4>
								</a>
							</li>
							<li class="p-t-4">
								<a href="{{ route('genres.index') }}" class="s-text13">
									All
								</a>
							</li>
							@foreach($genres as $genre)
								<li class="p-t-4">
									<a href="{{ route('genres.index', ['id' => $genre->id]) }}" class="s-text13">
										{{ $genre->name }}
									</a>
								</li>
							@endforeach
					...
					<div class="flex-sb-m flex-w p-b-35">
						<div class="flex-w">
							<div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
								...
								<input type="hidden" name="id" id="genre" value="{{ $currentGenre->id ?? 0 }}">
								</form>
							</div>
						</div>

						<span class="s-text8 p-t-5 p-b-5">
							Showing {{ $games->count() }} of {{ $games->total() }} results in <b>{{ $currentGenre->name ?? "All"}}</b> genre
						</span>
					</div>
