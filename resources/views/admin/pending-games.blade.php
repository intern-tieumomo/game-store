...
@section('title', 'Pending Games || Game Store')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Pending Games</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Publish Game
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <table class="table data-thumb-view">
                            ...
                            <tbody>
                            	@foreach($pendingGames as $game)
                                    <tr>
                                        <td></td>
                                        <td class="product-img"><img src="{{ asset('client/images/pending_games/' . $game->id . '/preview.jpg') }}" alt="Img placeholder">
                                        <td class="product-title">{{ $game->title }}</td>
                                        <td class="product-price">{{ $game->price . config('string.vnd') }}</td>
                                        ...
                                        <td class="product-action">
                                            <span class="action-publish" data-id="{{ $game->id }}"><i class="feather icon-check-circle"></i></span>
...
@section('js')
	...
	<script src="bower_components/admin/js/pages/pending-games.js"></script>
