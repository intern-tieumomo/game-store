...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/bower_components/client/vendor/summernote/summernote.min.css') }}">
    @yield('css')
...
<body class="animsition">
        ...
        <div class="container-menu-header">
            ...
            <div class="wrap_header">
                ...
                <div class="header-icons">
                    @if (Auth::check())
                        @if (isAdmin())
                            <a href="{{ route('admin.index') }}" class="header-wrapicon1 dis-block">
                                <img src="{{ asset('client/images/icons/icon-header-03.png') }}" class="header-icon1">
                            </a>
                        @else
        ...
        <div class="flex-w p-b-90">
            ...
            <div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
                ...
                <ul>
                    ...
                    <li class="p-b-9">
                        <a href="javascript:void(0)" class="s-text7">
                            {{ trans('text.app.videos') }}
                        </a>
                    </li>

                    <li class="p-b-9">
                        <a href="{{ route('blogs.index') }}" class="s-text7">
            ...
            <div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
                ...
                <ul>
                    <li class="p-b-9">
                        <a href="{{ route('profile.index') }}" class="s-text7">
    ...
    <script type="text/javascript" src="{{ asset('/bower_components/client/vendor/summernote/summernote.min.js') }}"></script>
