                        ...
                        <table class="table data-list-view">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="product-amount" id="product-amount">{{ moneyFormat($payment->amount) . config('string.vnd') }}</td>
                                    <td class="product-action">
                                        <span class="action-edit" data-id="{{ $payment->id }}"><i class="feather icon-edit"></i></span>
                                        <span class="action-delete" data-id="{{ $payment->id }}"><i class="feather icon-trash"></i></span>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
